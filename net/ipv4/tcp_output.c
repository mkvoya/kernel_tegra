 ...
 *  Author           Date                    Comment
 * ========   ===========   ================================================
 * Motorola   2011-09-01    limit mss be no bigger than 1372(0x55C) to solve
 *                          compatibility issue with CMCC, IKAROWANA-8739
 */
...
/*
 * limit mss to be not bigger than 1372(0x055C) to solve
 * compatiblity issue with CMCC, IKAROWANA-8739
 */
...
static __u16 tcp_advertise_mss(struct sock *sk)
{
	...
	/*
	 * to solve compatiblity issue with CMCC, IKAROWANA-8739
	 */
	if (mss > EZX_MAX_TCP_SEGMENT_SIZE) {
		mss = EZX_MAX_TCP_SEGMENT_SIZE;
		tp->advmss = EZX_MAX_TCP_SEGMENT_SIZE;
	}
